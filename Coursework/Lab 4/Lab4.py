...
#-------------------------------------------------------------
def savePicture(source, picName):
  FileChooser.setMediaPath("C:\Users\LN\Pictures\Lab 4")
  outPicture = getMediaPath(picName)
  writePictureTo(source, outPicture)
#  writePictureTo(picture, pickAFile())
  print "Your file " + picName + " was successfully saved!"
#
#
#-------------------------------------------------------------
#  WARM UP
...
def halfBetter(hbPic):
  ...
  for x in range(beginX, endX, stepX):
    for y in range(beginY, endY, stepY):
      ...
      #
      newX = endX - 1 + x
      pix = getPixel(hbPic, newX, y)
      pixColor = getColor(pix)
      # 
      newPix = getPixel(newPic, newX, y)
      setColor(newPix, pixColor)
...
#
  savePicture(picHalfBetter, "halfBetter.jpg")
  savePicture(picVertMirror, "VertMirror.jpg")
  savePicture(picTopMirror, "TopMirror.jpg")
  savePicture(picBottomMirror, "BottomMirror.jpg")
  savePicture(picDoubleMirror,"picDoubleMirror.jpg")
  savePicture(picRotate, "picRotat.jpg")
  savePicture(picShrink, "picShrink.jpg")
#  writePictureTo(picVertMirror, getMediaPath("VertMirror.jpg"))
#  writePictureTo(picTopMirror, getMediaPath("TopMirror.jpg"))
#  writePictureTo(picBottomMirror, getMediaPath("BottomMirror.jpg"))
#  writePictureTo(picDoubleMirror, getMediaPath("picDoubleMirror.jpg"))
#  writePictureTo(picRotate, getMediaPath("picRotat.jpg"))
#  writePictureTo(picShrink, getMediaPath("picShrink.jpg"))